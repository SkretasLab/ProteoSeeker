...
def diamond_first_round_fpd(diamond_env, output_path_hmmer, output_path_blastp, prs_with_enz_domains, blastp_results_no_doms_nr_file, blastp_info_no_doms_nr_file, blastp_no_doms_below_threshold, blastp_info_no_doms_below_threshold, cd_hit_results_path, file_prs_seq_no_enzs_name, fpr_db_fasta, fpr_db_name, e_value_nodom_thr, thread_num, input_log_file, output_log_file, diamond_path, blastp_nodoms_script, diamond_blastp_nr1_stdoe_path, conda_sh_path, diamond_blastp_par):
    ...
    if os.path.exists(file_prs_seq_no_enzs_name):
        if os.path.exists(fpr_db_fasta):
            ...
            if diamond_blastp_par is None:
                diamond_blastp_par = " --threads {} ".format(thread_num)
            else:
                if diamond_blastp_par[0] != " ":
                    diamond_blastp_par = " {}".format(diamond_blastp_par)
                if diamond_blastp_par[-1] != " ":
                    diamond_blastp_par = "{} ".format(diamond_blastp_par)
                    
            # Start time
            if diamond_path:
                phrase_1 = "\"{}\" blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_path, diamond_blastp_par, fpr_db_name, blastp_results_no_doms_nr_file, file_prs_seq_no_enzs_name, diamond_blastp_nr1_stdoe_path)
                phrase_2 = ""
            else:
                phrase_1 = "diamond blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_blastp_par, fpr_db_name, blastp_results_no_doms_nr_file, file_prs_seq_no_enzs_name, diamond_blastp_nr1_stdoe_path)
                phrase_2 = ""
...
def diamond_second_round_swissprot_fpd(diamond_env, output_path_blastp, blastp_results_swissprot_file, blastp_doms_nr_file, blastp_info_swissprot_file, blastp_doms_info_nr_file, file_prs_seq_enz_domains_name, proteins_combined_file, swissprot_path, fpr_db_fasta, fpr_db_name, thread_num, input_log_file, output_log_file, diamond_path, blast_swissprot_bash_script, blast_nr_bash_script, phylo_analysis, conda_sh_path, diamond_blastp_swissprot_stdoe_path, diamond_blastp_nr2_stdoe_path, diamond_blastp_par):
    ...
    if os.path.exists(proteins_combined_file):
        ...
        if os.path.exists(swissprot_path):
            ...
            if diamond_path:
                phrase_1 = "\"{}\" blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_path, diamond_blastp_par, swissprot_path, blastp_results_swissprot_file, proteins_combined_file, diamond_blastp_swissprot_stdoe_path)
                phrase_2 = ""
            else:
                phrase_1 = "diamond blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_blastp_par, swissprot_path, blastp_results_swissprot_file, proteins_combined_file, diamond_blastp_swissprot_stdoe_path)
                phrase_2 = ""
            # Create the Bash script.
            # Four cases: 1: Conda environment and path needed for the script. 2: Conda environment and no path needed for the script. 3: No conda environment and path needed for the script. 4: No conda environment and no path needed for the script.
    ...
    if phylo_analysis:
        ...
        if os.path.exists(swissprot_path) and os.path.exists(file_prs_seq_enz_domains_name):
            ...
            if diamond_path:
                phrase_1 = "\"{}\" blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_path, diamond_blastp_par, swissprot_path, blastp_results_swissprot_file, file_prs_seq_enz_domains_name, diamond_blastp_swissprot_stdoe_path)
                phrase_2 = ""
            else:
                phrase_1 = "diamond blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_blastp_par, swissprot_path, blastp_results_swissprot_file, file_prs_seq_enz_domains_name, diamond_blastp_swissprot_stdoe_path)
                phrase_2 = ""
    ...
    if os.path.exists(file_prs_seq_enz_domains_name):
        ...
        if os.path.exists(fpr_db_fasta):
            ...
            if diamond_path:
                phrase_1 = "\"{}\" blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_path, diamond_blastp_par, fpr_db_name, blastp_doms_nr_file, file_prs_seq_enz_domains_name, diamond_blastp_nr2_stdoe_path)
                phrase_2 = ""
            else:
                phrase_1 = "diamond blastp{}--db \"{}\" --out \"{}\" --query \"{}\" --outfmt 6 &> \"{}\"".format(diamond_blastp_par, fpr_db_name, blastp_doms_nr_file, file_prs_seq_enz_domains_name, diamond_blastp_nr2_stdoe_path)
                phrase_2 = ""
