...
def bowtie(output_path_bowtie, paired_end, tr_ex_file_paths, tr_ex_file_paths_p, conda_sh_path, bowtie_build_path, bowtie_build_version_path, bowtie_build_stdoe_path, bowtie_env, bowtie_bash_script, bowtie_path, bowtie_version_path, bowtie_stdoe_path, bowtie_single_unaligned_path, bowtie_paired_unaligned_con_path, bowtie_stats_path, mapped_reads_path, thread_num, output_final_contigs_formated, bowtie_contigs_basename, input_log_file, output_log_file, bowtie_par):
    ...
    if os.path.exists(output_final_contigs_formated):
        ...
        if bowtie_par is None:
            bowtie_par = " --very-sensitive --omit-sec-seq -p {}  ".format(thread_num)
        else:
            if bowtie_par[0] != " ":
                bowtie_par = " {}".format(bowtie_par)
            if bowtie_par[-1] != " ":
                bowtie_par = "{} ".format(bowtie_par)
        ...
        if paired_end:
            ...
            for key_file in range(0, len(tr_ex_file_paths_keys)):
                ...
                if key_file + 1 == len(tr_ex_file_paths_keys):
                    ...
                    paired_two_phrase = "{}{},".format(paired_two_phrase, file_path_2)
            if bowtie_path:
                phrase_3 = "\"{}\"{}-x \"{}\" -1 \"{}\" -2 \"{}\" --un \"{}\" --un-conc \"{}\" --met-file \"{}\" -S \"{}\" &> \"{}\"".format(bowtie_path, bowtie_par, bowtie_contigs_basename, paired_one_phrase, paired_two_phrase, bowtie_single_unaligned_path, bowtie_paired_unaligned_con_path, bowtie_stats_path, mapped_reads_path, bowtie_stdoe_path)
                phrase_4 = "\"{}\" --version > \"{}\"".format(bowtie_path, bowtie_version_path)
            else:
                phrase_3 = "bowtie2{}-x \"{}\" -1 \"{}\" -2 \"{}\" --un \"{}\" --un-conc \"{}\" --met-file \"{}\" -S \"{}\" &> \"{}\"".format(bowtie_par, bowtie_contigs_basename, paired_one_phrase, paired_two_phrase, bowtie_single_unaligned_path, bowtie_paired_unaligned_con_path, bowtie_stats_path, mapped_reads_path, bowtie_stdoe_path)
            ...
            for i in range(0, len(tr_ex_file_paths)):
                ...
                if i + 1 == len(tr_ex_file_paths):
                    ...
                    single_phrase = "{}{},".format(single_phrase, file_path)
            if bowtie_path:
                phrase_3 = "\"{}\"{}-x \"{}\" -U \"{}\" --un \"{}\" --un-conc \"{}\" --met-file \"{}\" -S \"{}\" &> \"{}\"".format(bowtie_path, bowtie_par, bowtie_contigs_basename, single_phrase, bowtie_single_unaligned_path, bowtie_paired_unaligned_con_path, bowtie_stats_path, mapped_reads_path, bowtie_stdoe_path)
                phrase_4 = "\"{}\" --version > \"{}\"".format(bowtie_path, bowtie_version_path)
            else:
                phrase_3 = "bowtie2{}-x \"{}\" -U \"{}\" --un \"{}\" --un-conc \"{}\" --met-file \"{}\" -S \"{}\" &> \"{}\"".format(bowtie_par, bowtie_contigs_basename, single_phrase, bowtie_single_unaligned_path, bowtie_paired_unaligned_con_path, bowtie_stats_path, mapped_reads_path, bowtie_stdoe_path)
                phrase_4 = "bowtie2 --version > \"{}\"".format(bowtie_version_path)
