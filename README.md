...
<p align="justify">At first, run the following Bash script from the main directory, to set up paths related to the conda installation in the parameter files described below.</p>
