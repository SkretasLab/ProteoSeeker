...
### 3.3.4 After preprocessing in the Docker container
<p align="justify">We note that currently the "after_preprocessing" parameter in the parameters files does not affect the function of ProteoSeeker. To skip the stages prior to the preprocessing as well as the preprocessing stage provide the value of "True" to the option of the command-line tool of ProteoSeeker (-afp/--after-preprocessing).</p>
