...
<p align="justify">We note that currently the "after_preprocessing" parameter in the parameters files does not affect the function of ProteoSeeker. To omit the stages prior to the preprocessing stage as well as the preprocessing stage provide the value "True" to the respective option of the command-line tool of ProteoSeeker, "-afp/--after-preprocessing".</p>
