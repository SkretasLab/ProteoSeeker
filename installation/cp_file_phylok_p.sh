...
echo "output_path=\"\"" >> parameters_phylok_p.txt
...
echo "analysis_mode=\"\"" >> parameters_phylok_p.txt
...
echo "only_seek_info=\"\"" >> parameters_phylok_p.txt
...
echo "conda_bin=\"${ABINPATH}\"" >> parameters_phylok_p.txt
