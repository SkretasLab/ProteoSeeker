...
PARAMETER_FILE="${PS_DIR}/parameters_seek_phylomc_p.txt"
...
echo "adapters_path=\"adapters.fa\"" >> "${PARAMETER_FILE}"
echo "protein_db_path=\"${PD_PATH}\"" >> "${PARAMETER_FILE}"
echo "kraken_db_path=\"ps_tools/kraken2/kraken_databases/minikraken2_v2_8GB_201904_UPDATE\"" >> "${PARAMETER_FILE}"
echo "profiles_path=\"\"" >> "${PARAMETER_FILE}"
echo "profiles_phylo_path=\"\"" >> "${PARAMETER_FILE}"
echo "profiles_broad_path=\"pfam_database/Pfam-A.hmm\"" >> "${PARAMETER_FILE}"
echo "swissprot_path=\"swissprot_dtb/swissprot\"" >> "${PARAMETER_FILE}"
echo "motifs_path=\"motifs.txt\"" >> "${PARAMETER_FILE}"
echo "output_path=\"/home/ps_data/output/SRR12829170_results\"" >> "${PARAMETER_FILE}"
echo "" >> "${PARAMETER_FILE}"

echo "#---------Protein family options---------" >> "${PARAMETER_FILE}"
echo "family_code=\"1191,3957\"" >> "${PARAMETER_FILE}"
echo "family_code_phylo=\"9050,9051,9052,9053,9054,9055,9056,9057,9058,9496\"" >> "${PARAMETER_FILE}"
echo "db_name=\"cas_als\"" >> "${PARAMETER_FILE}"
echo "db_name_phylo=\"phylo_1\"" >> "${PARAMETER_FILE}"
...
echo "create_nr_db_status=\"True\"" >> "${PARAMETER_FILE}"
...
echo "kraken_mode=\"False\"" >> "${PARAMETER_FILE}"
...
echo "bin_contig_len=\"200\"" >> "${PARAMETER_FILE}"
...
echo "conda_bin=\"${ABINPATH}\"" >> "${PARAMETER_FILE}"
...
echo "fraggenescanrs_path=\"ps_tools/fgsrs/FragGeneScanRs\"" >> "${PARAMETER_FILE}"
