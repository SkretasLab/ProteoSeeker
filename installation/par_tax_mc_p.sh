...
PARAMETER_FILE="${PARAM_DIR}/par_seekF_taxT2_paired.txt"
...
# Taxonomy - COMEBin/MetaBinner - Paired
...
echo "output_path=\"${PS_DIR}/results/SRR12829170_tax_mc_p\"" >> "${PARAMETER_FILE}"
echo "" >> "${PARAMETER_FILE}"

echo "#---------Modes and Routes---------" >> "${PARAMETER_FILE}"
echo "seek_mode=\"False\"" >> "${PARAMETER_FILE}"
echo "taxonomy_mode=\"True\"" >> "${PARAMETER_FILE}"
echo "seek_route=\"\"" >> "${PARAMETER_FILE}"
echo "taxonomy_route=\"2\"" >> "${PARAMETER_FILE}"
echo "" >> "${PARAMETER_FILE}"

echo "#---------Protein family options---------" >> "${PARAMETER_FILE}"
echo "seek_family_code=\"\"" >> "${PARAMETER_FILE}"
echo "taxonomy_family_code=\"9050,9051,9052,9053,9054,9055,9056,9057,9058,9496\"" >> "${PARAMETER_FILE}"
echo "seek_db_name=\"\"" >> "${PARAMETER_FILE}"
echo "taxonomy_db_name=\"tax_1\"" >> "${PARAMETER_FILE}"
...
echo "after_mapping=\"\"" >> "${PARAMETER_FILE}"
