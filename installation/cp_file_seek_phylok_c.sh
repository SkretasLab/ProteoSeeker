...
echo "output_path=\"/home/ps_data/output/SRR12829170_results\"" >> parameters_seek_phylok_c.txt
...
echo "seek_route=\"\"" >> parameters_seek_phylok_c.txt
...
echo "add_seek_info=\"\"" >> parameters_seek_phylok_c.txt
echo "add_taxonomy_info=\"\"" >> parameters_seek_phylok_c.txt
...
echo "filtering_threads=\"\"" >> parameters_seek_phylok_c.txt
echo "" >> parameters_seek_phylok_c.txt
...
echo "up_to_sra=\"\"" >> parameters_seek_phylok_c.txt
